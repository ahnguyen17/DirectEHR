...
// Diagnostics API functions (Imaging & Studies)
...
// Problem List API functions
export const problemListApi = {
  // Get all problems
  getAll: () => apiRequest('/problems'),

  // Get problems for a patient
  getByPatientId: (patientId) => apiRequest(`/patients/${patientId}/problems`),

  // Create a new problem
  create: (problem) => apiRequest('/problems', 'POST', problem),

  // Update a problem
  update: (id, problem) => apiRequest(`/problems/${id}`, 'PUT', problem),

  // Delete a problem
  delete: (id) => apiRequest(`/problems/${id}`, 'DELETE'),
};
